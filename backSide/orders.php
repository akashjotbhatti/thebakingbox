...
<body>
	...
	<a href="orderForm.php" class="addBtn"><i class="fas fa-plus"></i>Add New Order</a>
	<div class="list">
		<div class="header">
			<div class="name">Order</div><!-- .name -->
	...
	?>
		<div class="details">
			<div class="detail">
				<h2><?=$bakingcms["full_name"]?></h2>
				<div class="editBtn">
				<a href="orderForm.php?id=<?=$bakingcms["id"]?>"><i class="fas fa-edit"></i></a>
			</div><!-- .detail -->

			<div class="deleteBtn">
				<a href="deleteorder.php?id=<?=$bakingcms["id"]?>"><i class="fas fa-trash"></i></a>
			</div><!-- .deleteBtn -->
		</div><!-- .details -->
	<?php
	}
