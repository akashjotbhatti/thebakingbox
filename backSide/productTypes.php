...
<body>
	...
	<a href="productTypesForm.php" class="addBtn"><i class="fas fa-plus"></i>Add New Product Types</a>
	<div class="list">
		<div class="header">
			<div class="name">Product Types</div><!-- .name -->
	...
	?>
		<div class="details">
			<div class="detail">
				...
				<div class="editBtn">
				<a href="productTypesForm.php?id=<?=$bakingcms["id"]?>"><i class="fas fa-edit"></i></a>
			</div><!-- .detail -->

			<div class="deleteBtn">
				<a href="deleteProductTypes.php?id=<?=$bakingcms["id"]?>"><i class="fas fa-trash"></i></a>
			</div><!-- .deleteBtn -->
		</div><!-- .details -->
	<?php
	}
