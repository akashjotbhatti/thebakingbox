...
<body>
	...
	<a href="userForm.php" class="addBtn"><i class="fas fa-plus"></i>Add New User</a>
	<div class="list">
		<div class="header">
			<div class="name">User</div><!-- .name -->
	...
	?>
		<div class="details">
			<div class="detail">
				<h2><?=$bakingcms["username"]?></h2>
				<div class="editBtn">
				<a href="userForm.php?id=<?=$bakingcms["id"]?>"><i class="fas fa-edit"></i></a>
			</div><!-- .detail -->

			<div class="deleteBtn">
				<a href="deleteUser.php?id=<?=$bakingcms["id"]?>"><i class="fas fa-trash"></i></a>
			</div><!-- .deleteBtn -->
		</div><!-- .details -->
	<?php
	}
